...
$date2    = new DateTime("03/27/2022 14:00:00.000000");

if ($date_now < $date2) {
   $d=mktime(14, 00, 00, 3, 2, 2022);
echo "Picks will be locked in for Day 8 on " . date("M-d-Y h:i:a", $d);
