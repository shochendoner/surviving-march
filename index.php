...
<section class="rules-text-01">
       ...
       <p> 1. Like any other survivor pool, once you pick a team once, you may not pick that same team again.
        ...
        4.a. The below is the set-up for how many picks are required to be made each day if you are correct:</p>
    ...
    <div>
      ...
      <ul>
        ...
        <p>Every following day is also 1 pick.</p>
        
        </div>
        
        <p>b.If you pick incorrectly, you are out unless you buy back in (see rule 5).</p>
    ...
    <h4>Re-entering the Game:</h4>
        ...
        <p>This is a survivor pool, and the reason for the above is to make it more difficult for those who have already picked a loser. You can buy-in as many times as you would like, but the last day to buy in would be Monday of the first weekend.  If you pick any loser on Monday or beyond, you can not buy back in.  And remember, just because you buy back in, it does not reset the teams you can choose from.  Each team you have chosen before is not available for selection again.  

        In the event that you have advanced and do not have anyone else remaining to choose from because you have chosen all of the teams before that round, you would still tie any player that does not correctly guess the next round.  For instance, if I were to have no remaining teams left after Sunday, but one other person was left and they did not pick a winner on Saturday, we would tie and split the pot.</p>
      </p>
